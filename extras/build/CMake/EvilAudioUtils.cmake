...
function(evilaudio_add_modules)
    evilaudio_add_module(
        INSTALL_PATH "include/JUCE-${JUCE_VERSION}/modules"
        ALIAS_NAMESPACE evil
        #juce_analytics
        #juce_animation
    )
endfunction()

function(evilaudio_add_module target)
    #juce_add_module(
        #${ARGN}
    #)
endfunction()
...
function(evilaudio_add_gui_app target)
    ...
    _evilaudio_configure_app_bundle(${target} ${target})
...
function(_evilaudio_configure_app_bundle source_target dest_target)
